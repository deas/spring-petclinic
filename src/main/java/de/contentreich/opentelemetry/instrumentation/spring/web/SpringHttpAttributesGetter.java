...
enum SpringHttpAttributesGetter implements HttpServerAttributesGetter<HttpServletRequest, HttpServletResponse> {
	...
	@Override
	public Integer getHttpResponseStatusCode(HttpServletRequest request, HttpServletResponse response,
	...
	@Override
	// @Nullable
	public String getNetworkPeerAddress(HttpServletRequest request, /* @Nullable */ HttpServletResponse response) {
		return request.getRemoteAddr();
	}

	@Override
	public Integer getNetworkPeerPort(HttpServletRequest request, /* @Nullable */ HttpServletResponse response) {
		return request.getRemotePort();
	}

	// @Nullable
	@Override
	public String getNetworkLocalAddress(HttpServletRequest request, /* @Nullable */ HttpServletResponse response) {
		return request.getLocalAddr();
	}

	@Override
	public Integer getNetworkLocalPort(HttpServletRequest request, /* @Nullable */ HttpServletResponse response) {
